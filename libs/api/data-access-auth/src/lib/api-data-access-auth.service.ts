...
import { ApiDataAccessCoreService } from '@stack-sandbox/api/data-access-core'
...
export class ApiDataAccessAuthService {
  constructor(private readonly data: ApiDataAccessCoreService, private readonly jwtService: JwtService) {}
